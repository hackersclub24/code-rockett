...
export default function Loading() {
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-[#05060d] px-6 py-10 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.16),transparent_38%),radial-gradient(circle_at_bottom,rgba(249,115,22,0.12),transparent_32%)]" />
